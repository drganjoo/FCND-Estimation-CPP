...
VectorXf QuadEstimatorEKF::PredictState(VectorXf curState, float dt, V3F accel, V3F gyro)
{
	...
	////////////////////////////// BEGIN STUDENT CODE ///////////////////////////
	// ref: 7.2 Transition Model of estimation-quadcopter.pdf
	...
	predictedState(3) = x_dot + accel_inertial.x * dt;
	predictedState(4) = y_dot + accel_inertial.y * dt;
	predictedState(5) = z_dot + accel_inertial.z * dt - CONST_GRAVITY * dt;
...
void QuadEstimatorEKF::Predict(float dt, V3F accel, V3F gyro)
{
	...
	V3F rbg_0(RbgPrime(0, 0), RbgPrime(0,1), RbgPrime(0,2));
	gPrime(3, 6) = rbg_0.dot(accel);

	V3F rbg_1(RbgPrime(1, 0), RbgPrime(1, 1), RbgPrime(1, 2));
	gPrime(4, 6) = rbg_1.dot(accel);
